class Hero
  ...
  while true
    ...
    finggers = ["0","1", "2","3"]
    # finggers（変数）に代入させる
    if (finggers.include?(input_fingger))
...
class BattleStart
  def self.attimuite_hoi
    ...
    next_battle = attimuite_hoi(hero_fingger,lastboss_face)
    end
  end
end

BattleStart.attimuite_hoi
